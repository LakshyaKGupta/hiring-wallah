...
{{
  ...
  "preferred": ["list of preferred but not strictly required skills/experience"],
  "red_flags": ["signals or missing items that would disqualify a candidate"],
  "success_signals": ["concrete resume evidence that would signal likely success in this role"],
